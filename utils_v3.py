...
def load_input_data(N=7, partition_part=1, feat_list=None, extended=True, label_size=None):
    ...
    return (
      InputData(features=features, rows_1=rows_1, columns_1=cols_1, rows_2=rows_2, columns_2=cols_2, labels=ys, root_nodes=root_nodes),
      InputData(features=features_train, rows_1=rows_1_train, columns_1=cols_1_train, rows_2=rows_2_train, columns_2=cols_2_train, labels=ys_train, root_nodes=root_nodes_train),
      InputData(features=features_test, rows_1=rows_1_test, columns_1=cols_1_test, rows_2=rows_2_test, columns_2=cols_2_test, labels=ys_test, root_nodes=root_nodes_test))
...
#                 gnns.append(gnns[-1])
    ...
    @functools.partial(jax.jit, device=jax.devices()[1] , static_argnums=(0,))
